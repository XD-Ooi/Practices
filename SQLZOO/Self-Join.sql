...
#Note: SQLZoo returned this as error when it was run although it returns the same result. Other answers also follow this pattern so there might be some issues with the answer verification part on SQLZOO's side.
